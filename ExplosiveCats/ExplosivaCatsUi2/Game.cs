...
public class Game
{
    ...
    public bool IsYourTurn => CurrentPlayer.PlayerId == _playerId;
    public MainPlayer MainPlayer => CurrentPlayer as MainPlayer;
    public int DeckCount { get; private set; }
    private Stack<GameAction> _actionHistory = new();

    public Game(List<Player> players, byte playerId)
    {
        Players = players;
